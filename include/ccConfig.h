...
*/
#ifndef CC_USES_VBO
#if (CC_TARGET_PLATFORM == CC_PLATFORM_MARMALADE || CC_TARGET_PLATFORM == CC_PLATFORM_WIN32 || CC_TARGET_PLATFORM == CC_PLATFORM_WIN8_METRO) //win32=>win8
...
/** @def CC_TEXTURE_ATLAS_USE_TRIANGLE_STRIP
 Use CC_TRIANGLE_STRIP instead of CC_TRIANGLES when rendering the texture atlas.
