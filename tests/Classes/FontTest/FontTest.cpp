...
void FontTest::showFont(const char *pFont)
{
	...
	CCLabelTTF *left = CCLabelTTF::labelWithString("alignment left", pFont, 32);
	CCLabelTTF *center = CCLabelTTF::labelWithString("alignment center",  pFont, 32);
	CCLabelTTF *right = CCLabelTTF::labelWithString("alignment right",  pFont, 32);
