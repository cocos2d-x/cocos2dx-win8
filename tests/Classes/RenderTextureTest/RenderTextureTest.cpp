...
: m_brush(NULL)
{
    ...
    ccBlendFunc bf = { CC_ONE, CC_ONE_MINUS_SRC_ALPHA };
...
RenderTextureIssue937::RenderTextureIssue937()
{
    ...
    */
    ...
    //		[[rend sprite] setBlendFunc:(ccBlendFunc) {CC_ONE, CC_ONE_MINUS_SRC_ALPHA}];
...
{
	CCRenderTexture *texture = CCRenderTexture::renderTextureWithWidthAndHeight(480,320/*512, 512*/);
	if (NULL == texture)
	{
		return;
	}
	...
	sprite->setPosition(ccp(240,160/*256, 256*/));
