...
void TextureBlend::onEnter()
{
	...
	for( int i=0;i < 15;i++ )
    {
		...
		// they use by default CC_ONE, CC_ONE_MINUS_SRC_ALPHA
		...
		// they use by default CC_SRC_ALPHA, CC_ONE_MINUS_SRC_ALPHA
